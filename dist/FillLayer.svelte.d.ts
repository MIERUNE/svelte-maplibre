...
export type FillLayerProps = typeof __propDef.props;
export type FillLayerEvents = typeof __propDef.events;
export type FillLayerSlots = typeof __propDef.slots;
export default class FillLayer extends SvelteComponentTyped<FillLayerProps, FillLayerEvents, FillLayerSlots> {
}
export {};
