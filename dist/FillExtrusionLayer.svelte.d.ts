...
export type FillExtrusionLayerProps = typeof __propDef.props;
export type FillExtrusionLayerEvents = typeof __propDef.events;
export type FillExtrusionLayerSlots = typeof __propDef.slots;
export default class FillExtrusionLayer extends SvelteComponentTyped<FillExtrusionLayerProps, FillExtrusionLayerEvents, FillExtrusionLayerSlots> {
}
export {};
