...
export type LineLayerProps = typeof __propDef.props;
export type LineLayerEvents = typeof __propDef.events;
export type LineLayerSlots = typeof __propDef.slots;
export default class LineLayer extends SvelteComponentTyped<LineLayerProps, LineLayerEvents, LineLayerSlots> {
}
export {};
