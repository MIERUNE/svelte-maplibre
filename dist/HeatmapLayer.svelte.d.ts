...
export type HeatmapLayerProps = typeof __propDef.props;
export type HeatmapLayerEvents = typeof __propDef.events;
export type HeatmapLayerSlots = typeof __propDef.slots;
export default class HeatmapLayer extends SvelteComponentTyped<HeatmapLayerProps, HeatmapLayerEvents, HeatmapLayerSlots> {
}
export {};
